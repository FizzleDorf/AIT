...
This repo is now depricated. New AIT developments will take place in a
[new repo](https://github.com/FizzleDorf/ComfyUI-AIT). This is due to a 
volitile foundation that too frequently needs fixing after ComfyUI updates.
The new repo was made alongside Comfyanonamous so this doesn't happen in the future.
